...
Fisher_axion = np.load('/home/paolo/Codes/SGWBProbeComb/files/LiteBIRD_Fisher_matrices/Fisher_0.01_AXION.npy')  
...
Fisher_axion2 = np.load('/home/paolo/Codes/SGWBProbeComb/files/LiteBIRD_Fisher_matrices/Fisher_2.0_AXION2.npy')  
...
plt.savefig('/home/paolo/Codes/SGWBProbeComb/figures/Fig_14.pdf', format='pdf', dpi=1000, bbox_inches='tight')
plt.show()
...
plt.savefig('/home/paolo/Codes/SGWBProbeComb/figures/Fig_15.pdf', format='pdf', dpi=1000, bbox_inches='tight')
plt.show()
...
plt.xlim(ax, bx)
plt.ylim(ay, by)
plt.savefig('/home/paolo/Codes/SGWBProbeComb/figures/Fig_16.pdf', format='pdf', dpi=1000, bbox_inches='tight')
plt.show()
